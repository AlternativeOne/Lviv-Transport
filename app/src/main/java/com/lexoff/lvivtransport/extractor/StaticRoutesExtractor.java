...
public class StaticRoutesExtractor extends Extractor {
    private String PATH="routes/static/%s";

    public StaticRoutesExtractor(Client client, String routeShortName){
        super(client, "");
